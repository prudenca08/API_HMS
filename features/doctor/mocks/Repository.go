...
func (_m *Repository) AllDoctor() ([]doctor.Domain, error) {
	ret := _m.Called()
...
func (_m *Repository) Delete(docID int, id int) (string, error) {
...
func (_m *Repository) DoctorByID(id int) (doctor.Domain, error) {
	ret := _m.Called(id)
...
func (_m *Repository) Login(username string, password string) (doctor.Domain, error) {
...
func (_m *Repository) Register(domain *doctor.Domain) (doctor.Domain, error) {
...
func (_m *Repository) Update(docID int, domain *doctor.Domain) (doctor.Domain, error) {
