...
func (_m *Repository) AllPatient() ([]patient.Domain, error) {
	ret := _m.Called()
...
func (_m *Repository) Create(patID int, domain *patient.Domain) (patient.Domain, error) {
...
func (_m *Repository) Delete(patID int, id int) (string, error) {
...
func (_m *Repository) PatientByID(id int) (patient.Domain, error) {
	ret := _m.Called(id)
...
func (_m *Repository) Update(admID int, patID int, domain *patient.Domain) (patient.Domain, error) {
