...
func (_m *Service) AllDocses() ([]docses.Domain, error) {
	ret := _m.Called()
...
func (_m *Service) Create(dsID int, domain *docses.Domain) (docses.Domain, error) {
...
func (_m *Service) DocsesByID(id int) (docses.Domain, error) {
	ret := _m.Called(id)
...
func (_m *Service) Update(admID int, dsID int, domain *docses.Domain) (docses.Domain, error) {
